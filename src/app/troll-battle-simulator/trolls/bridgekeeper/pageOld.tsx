  ...
  >
    ...
    <div
      className="w-full md:w-1/3 max-w-full min-w-[400px] p-1
        bg-[#6d6f50] flex flex-col items-center justify-center h-full"
    >
      {/* Scroll parchment as background */}
      <div
        className="relative w-full h-full overflow-hidden max-w-xl p-6 pt-14 text-center
          bg-[url('/scroll-bg.png')] bg-no-repeat bg-contain bg-center"
        style={{ backgroundSize: '100% 100%' }}
        ref={scrollContainerRef}
      >
        <h1
          className="mb-4 font-bold text-red-900 select-none drop-shadow-md text-center leading-tight"
          style={{
